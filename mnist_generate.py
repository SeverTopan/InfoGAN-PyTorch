...
plt.axis("off")
plt.imshow(np.transpose(vutils.make_grid(generated_img1, nrow=9, padding=2, normalize=True), (1,2,0)))
...
fig = plt.figure(figsize=(10, 10))
plt.axis("off")
plt.imshow(np.transpose(vutils.make_grid(generated_img2, nrow=9, padding=2, normalize=True), (1,2,0)))
